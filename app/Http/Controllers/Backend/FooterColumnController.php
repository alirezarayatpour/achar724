...
class FooterColumnController extends Controller
{
   ...
   public function index()
   {
      ...
      return view('admin.pages.footer-column.index', compact('footerColumn'));
   }
   ...
   {
      return view('admin.pages.footer-column.create');
   }
   ...
   public function store(StoreFooterColumnRequest $request)
   {
      ...
      return redirect()->route('footer-column.index')->with('success', $message);
   }
   ...
   {
      return view('admin.pages.footer-column.edit', compact('footerColumn'));
   }
