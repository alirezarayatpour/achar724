...
class HeaderItemController extends Controller
{
   ...
   public function index()
   {
      ...
      return view('admin.pages.header-item.index', compact('headerItem'));
   }
   ...
   {
      return view('admin.pages.header-item.create');
   }
   ...
   public function store(StoreHeaderItemRequest $request)
   {
      ...
      return redirect()->route('header-item.index')->with('success', $message);
   }
   ...
   {
      return view('admin.pages.header-item.edit', compact('headerItem'));
   }
