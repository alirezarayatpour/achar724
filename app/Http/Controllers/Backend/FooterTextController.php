...
class FooterTextController extends Controller
{
   ...
   public function index()
   {
      ...
      return view('admin.pages.footer-text.index', compact('footerText'));
   }
   ...
   {
      return view('admin.pages.footer-text.create');
   }
   ...
   public function store(StoreFooterTextRequest $request)
   {
      ...
      return redirect()->route('footer-text.index')->with('success', $message);
   }
   ...
   {
      return view('admin.pages.footer-text.edit', compact('footerText'));
   }
