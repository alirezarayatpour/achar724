...
class FooterItemController extends Controller
{
   ...
   public function index()
   {
      ...
      return view('admin.pages.footer-item.index', compact('footerItem'));
   }
   ...
   {
      return view('admin.pages.footer-item.create');
   }
   ...
   public function store(StoreFooterItemRequest $request)
   {
      ...
      return redirect()->route('footer-item.index')->with('success', $message);
   }
   ...
   {
      return view('admin.pages.footer-item.edit', compact('footerItem'));
   }
